...
const API_CONFIG = {
  ...
  ENDPOINTS: {
    ...
    UPDATE: "/formData/shipping",
    DELETE: "/formData/shipping",
  },
};
...
const EDIT_FIELDS = [
  { name: "financeDate", label: "Finance Date", type: "date" },
  {
    name: "financeRate",
    label: "Currency",
    type: "select",
  ...
  { name: "billOfLadingNo", label: "Bill of Lading No.", type: "text" },
  { name: "invoiceNo", label: "Invoice No.", type: "text" },
  { name: "vesselNo", label: "Vessel No.", type: "text" },
...
const PiFinanceShippingDetails = () => {
  ...
  const handleExportCSV = useCallback(() => {
    ...
    link.setAttribute(
      "download",
      `finance-shipping-details-${selectedYear || "all-years"}-${
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-orange-100">
      ...
      {editingRecord && (
        <EditModal
          title="Edit Finance & Shipping Details"
          fields={EDIT_FIELDS}
          values={editForm}
