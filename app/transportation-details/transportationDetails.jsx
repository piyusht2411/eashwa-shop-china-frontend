...
const API_CONFIG = {
  ...
  ENDPOINTS: {
    TRANSPORTATION_DETAILS: "/formData/all-transport-details",
    UPDATE: "/formData/transportation",
    DELETE: "/formData/transportation",
  },
};
...
const EDIT_FIELDS = [
  ...
  { name: "eWayBillNumber", label: "E-Way Bill Number", type: "number" },
  { name: "amountOfTransport", label: "Amount of Transport", type: "number" },
  { name: "finalDestination", label: "Final Destination", type: "text" },
  { name: "boeNo", label: "BOE No.", type: "text" },
  {
    name: "detailRate",
    label: "Detail Rate",
    type: "select",
  ...
  { name: "totalAmout", label: "Total Amount", type: "number" },
];
...
const EmptyState = () => (
  <div className="bg-white rounded-xl border border-orange-200 p-12 text-center">
    ...
    <h3 className="text-xl font-semibold text-gray-800 mb-2">
      No Transportation Details Found
    </h3>
    <p className="text-gray-600">
      There are no transportation details to display at the moment.
    </p>
  </div>
);
...
const TransportationDetails = () => {
  ...
  useEffect(() => {
    console.log("API_CONFIG:", API_CONFIG); // Debug API_CONFIG
    fetchDetails();
  }, [fetchDetails]);
  ...
  }, [editingRecord, editForm, fetchDetails]);
  ...
  const handleExportCSV = useCallback(() => {
    const csvData = details.map((detail, index) => ({
      ...
      "E-Way Bill Number": detail.eWayBillNumber || "-",
      "Amount of Transport": formatCurrency(detail.amountOfTransport),
    ...
    link.setAttribute(
      "download",
      `transportation-details-${selectedYear || "all-years"}-${
        selectedMonth || "all-months"
      }-${new Date().toISOString().slice(0, 10)}.csv`
    );
    link.click();
    URL.revokeObjectURL(url);
  }, [details, currentPage, itemsPerPage, selectedYear, selectedMonth]);
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              <div>
                <h1 className="text-3xl font-bold text-white flex items-center gap-3">
                  ...
                  Transportation Details Dashboard
                </h1>
                <p className="text-orange-100 mt-1">
                  E-Way Bill and Transport Management System
                </p>
              </div>
