...
const API_CONFIG = {
  ...
  ENDPOINTS: {
    CLEARANCE_DETAILS: "/formData/all-clearance-details", // Adjust endpoint as per your API
    UPDATE: "/formData/clearance",
    DELETE: "/formData/clearance",
  },
};
...
const EDIT_FIELDS = [
  ...
  { name: "dutyAmout", label: "Duty Amount", type: "number" },
  {
  ...
  { name: "clearanceDate", label: "Clearance Date", type: "date" },
];
...
const formatDutyPaid = (dutyPaid) => {
  if (dutyPaid === true || dutyPaid === "true") return "Yes";
  if (dutyPaid === false || dutyPaid === "false") return "No";
  return "-";
};
...
const ClearanceDetails = () => {
  ...
  const handleExportCSV = useCallback(() => {
    ...
    link.setAttribute(
      "download",
      `clearance-details-${selectedYear || "all-years"}-${
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  onClick={() => router.push("/clearance")} // Route to Clearance form
                >
                  <svg
                    className="w-4 h-4"
                    fill="none"
