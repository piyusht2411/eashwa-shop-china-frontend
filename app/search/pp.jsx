...
const TableHeader = ({ children }) => (
  <th className="px-6 py-4 text-left text-xs font-semibold text-orange-700 uppercase tracking-wider bg-gradient-to-r from-orange-50 to-orange-100 whitespace-nowrap">
    {children}
  </th>
);
                      ...
                      <table className="w-full min-w-full table-fixed">
                        ...
                        <tbody className="divide-y divide-gray-200">
                          {searchResults.shippingDetails.length > 0 ? (
                            searchResults.shippingDetails.map(
                              (detail, index) => (
                                <tr
                                  key={detail.piNumber || index}
                                  className="hover:bg-orange-50 transition-colors"
